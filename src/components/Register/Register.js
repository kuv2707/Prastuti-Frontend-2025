      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <div className="absolute z-10 flex h-[37rem] w-[22rem] sm:w-[30rem] mt-30 bg-[#DBF2FF] mx-auto shadow-2xl shadow-dark-neon-tint rounded-lg bg-opacity-65 lg:max-w-4xl">
          ...
          <div className="absolute w-full content-center p-6 md:px-8 ">
            ...
            {/* <div */}
            {/* // href="#" // className="flex items-center justify-center mt-4
            bg-[#003247] text-[#DBF2FF] transition-colors duration-300 transform
            border rounded-lg hover:text-[#003247] hover:border-[#003247]
            focus:outline-none focus:bg-[#DBF2FF] focus:text-[#003247]
            focus:border-[#003247]" */}
            {/* > */}
            ...
            {/* Sign in with Google  */}
            <GoogleLogin
              className="align-top justify-center w-5/6 px-4 py-3 font-bold text-black text-center loginBtn flex items-center mt-4 ml-9"
              clientId={clientId}
