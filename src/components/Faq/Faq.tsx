...
const Faq = () => {
	const [faqs, setfaqs] = useState([
		{
			...
			answer: `Prastuti'24 is commencing on 17th January and will continue up to the month of April.
	...
	// console.log(faqs);
	function FAQ({ faq, index, toggleFAQ }: { faq: { question: string; answer: string; open: boolean }; index: number; toggleFAQ: (index: number) => void }) {
		return (
			<div
	...
	return (
		<div className="app" id="faqs">
			<header>
				<h1>
					Frequently <br />{" "}
					<span className="ask">Asked</span> <br />{" "}
					Questions
				</h1>
			</header>
