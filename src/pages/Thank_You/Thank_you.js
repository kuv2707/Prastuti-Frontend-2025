  ...
  return (
    <div className="flex flex-col justify-center text-[#DBF2FF] md:flex-row">
      <div className="flex justify-evenly align-middle flex-col w-full h-[75vh] text-center space-between p-4 md:w-1/2 md:h-screen ">
        <div>
          <h1 className="mb-10 text-3xl font-extrabold text-white :text-5xl lg:text-6xl font-Manrope">
            <span className="text-transparent bg-clip-text bg-gradient-to-r to-[#DBF2FF] from-sky-500 font-Manrope">
              SUCCESSFULLY{" "}
            </span>
            REGISTERED.
          </h1>
        ...
        <div>
          ...
          <h1 className="m-2 text-3xl font-extrabold text-white :text-5xl lg:text-6xl font-Manrope">
            {" "}
            Thank You for registering for the 24th Edition of Prastuti!
          </h1>
        </div>
        <span>
          <Link
            to="/profile/#"
            className="relative inline-flex items-center justify-center px-10 py-3 overflow-hidden font-medium text-[#DBF2FF] transition duration-300 ease-out border-2 border-[#DBF2FF] rounded-full shadow-md group w-1/2 lg:w-1/4"
          >
            ...
            <span className="absolute flex items-center justify-center w-full h-full font-Catamaran text-[#DBF2FF] transition-all duration-300 transform group-hover:translate-x-full ease">
              Go to Profile
            </span>
      ...
      <div className="flex w-full h-auto justify-items-start align-middle flex-col md:w-1/2 md:h-screen md:justify-evenly">
        <a
          href="https://play.google.com/store/apps/details?id=com.prastuti.prastuti_23"
          target="_blank"
          rel="noreferrer"
          className="flex justify-center mt-10"
        >
          <span className="AppText underline underline-offset-2">
            {" "}
        ...
        <span className="max-w-[400px] max-h-[400px] w-fit h-fit flex justify-center py-2 mx-auto">
          <img
            className="w-25 h-25 sm:drop-shadow-lg sm:w-full sm:h-full mx-auto"
            src={require("../Thank_You/app.png")}
            alt="logo"
          ></img>
        </span>
        <div className="flex flex-col justify-between align-middle ">
          <h1 className="flex justify-center py-2 text-2xl font-bold m-2 AppText2">
          ...
          <ul className="flex justify-center py-2">
            ...
            <li className='social-links font-["Manrope"] justify-center text-white mx-5 text-l my-4 '>
              <a
                href="https://www.youtube.com/@prastuti2023"
                target="_blank"
                rel="noreferrer"
              >
                <IconContext.Provider value={{ className: "react-icons" }}>
