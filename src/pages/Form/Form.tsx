...
const Form1 = () => {
	...
	return (
		<div>
			...
			<section
				className="bg-cover -z-10 h-max md:h-full"
				style={divStyle}
			>
						...
						<div className="flex-1 lg:flex lg:items-center lg:mx-6">
							<div className="text-white px-2  lg:w-1/2 lg:mx-6">
								...
								<p className="max-w-xl font-Manrope mt-6">
									Electrical Department of IIT
									(BHU) Varanasi presents
									PRASTUTI, the annual technical
									festival that echoes the spirit
									of innovation and progress! Just
									one more step to go for you to
							...
							<div className="block h-[30rem] px-0 w-full mt-2 md:w-full lg:w-max lg:mx-6 overflow-visible md:overflow-auto scroll-smooth">
								<div className="w-full px-8 bg-white  py-10 mx-auto shadow-2xl lg:max-w-xl">
									...
									<p className="mt-4 font-Catamaran text-gray-500 ">
										...
										about You! This form can
										only be filled once and is
										Mandatory so be careful!
									</p>
